...
const FAQS = [
  {
    ...
    answer:
      "No, es necesario crear una cuenta para realizar reservas. El registro es rápido y gratuito, y te permite gestionar tus reservas fácilmente.",
  },
  {
    question: "¿Cuál es la política de cancelación?",
    answer:
      "La política de cancelación varía según cada propiedad. Puedes consultar los términos específicos en la página de cada alojamiento antes de reservar.",
  },
  {
    question: "¿Cómo puedo contactar al anfitrión?",
    answer:
      "Una vez realizada la reserva, tendrás acceso a los datos de contacto del anfitrión a través de tu panel de usuario.",
  },
  {
    question: "¿Hay cargos adicionales?",
    answer:
      "Todos los cargos deben estar especificados en el detalle de la reserva. Algunas propiedades pueden requerir un depósito de seguridad que será reembolsable.",
  },
  {
    question: "¿Puedo modificar mi reserva?",
    answer:
      "Las modificaciones dependen de la disponibilidad y la política de la propiedad. Puedes solicitar cambios contactando al anfitrión directamente.",
  },
];
const FaqItem = ({ question, answer }) => {
  ...
  return (
    <div
      className={`border-b border-gray-100 py-5 transition-all duration-200 ${isOpen ? "bg-gray-50 rounded-lg px-4 -mx-4" : ""}`}
    >
      <button
...
const Page = () => {
  ...
  const destinationsWithCount = useMemo(() => {
    ...
    properties.forEach((property) => {
      ...
      const normalizedCity = city.includes("Buenos Aires")
        ? "Buenos Aires"
        : city;
